Vue.component("user-orders", {
    ...
    <div>    
        <div class="row" >
            <div class="col-12">
                <img src="images/orders.png" alt="" width="90%" height="350" style="margin-left: 90px;">
            </div>
        </div>
        <div class="row" style="margin-left: 200px; margin-top: 50px; font-size: 22px; text-align: center;" v-if="orders.length === 0">
            <div class="col-10">
                <label for="" style="font-size: 40px; " > Nema porudžbina! </label>
            </div>
        </div>
        <div v-else>
            <div class="row">
